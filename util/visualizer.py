...
class COCOVisualizer():
    ...
    def visualize(self, img, tgt, caption=None, dpi=120, savedir=None, show_in_console=True, return_boxes=False,):
        """
        img: tensor(3, H, W)
        ...
        boxes = self.addtgt(tgt)
        if show_in_console and not return_boxes:
            plt.show()
